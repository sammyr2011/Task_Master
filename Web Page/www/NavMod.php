...
$unread = array();
$unread = getUnreadMessages($_SESSION['userid']);
        ...
        <div class="container-fluid">
            ...
            <div>
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="MessageCenter.php">Message Center<span id="NewMessages" style="color:red"> (<?php echo count($unread) ?>)</span></a></li>
                </ul>
